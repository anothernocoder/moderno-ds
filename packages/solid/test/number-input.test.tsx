...
describe("NumberInput surface (Solid)", () => {
  it("exposes every Ark part, not a hand-maintained subset", async () => {
    const { NumberInput: ArkNumberInput } = await import("@ark-ui/solid");
...
describe("NumberInput", () => {
  ...
  it("formats the value with formatOptions", () => {
    render(() => (
      <Demo defaultValue="1234.5" formatOptions={{ style: "currency", currency: "USD" }} />
    ));
  ...
  it("follows a controlled value", async () => {
    ...
    setValue("7");
    // Ark writes the new value into the input after the update.
