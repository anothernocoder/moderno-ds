...
import { Callout, type CalloutVariant } from "../src/callout.jsx";

afterEach(cleanup);

function Sample(props: { variant?: CalloutVariant }) {
  return (
    <Callout.Root variant={props.variant}>
  ...
  it("forwards native props to the parts", () => {
    const { container } = render(() => (
      <Callout.Root id="export-note" data-testid="root">
        <Callout.Title class="mine">Heads up</Callout.Title>
      </Callout.Root>
    ));
