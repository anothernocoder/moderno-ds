...
import PaginationSection from "../../playground/sections/pagination.jsx";

describe("Pagination SSR (Solid)", () => {
  it("server-renders its playground section to a stable HTML string", () => {
    const html = renderToString(() => <PaginationSection open={false} />);
    // Ark's pagination machine. The recipe lands on each root; each root
    // reaches the server as a named <nav> with its page list (an ellipsis on
    // both sides of page 5), the current page marked, and prev already
