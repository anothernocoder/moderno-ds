...
import TabsSection from "../../playground/sections/tabs.jsx";

describe("Tabs SSR (Solid)", () => {
  it("server-renders its playground section to a stable HTML string", () => {
    ...
    // data-selected), every panel is labelled by its own tab's id, the panels
    // of unselected tabs are hidden, and a disabled tab is a disabled button.
