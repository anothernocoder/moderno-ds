...
import RadioGroupSection from "../../playground/sections/RadioGroup.svelte";

describe("RadioGroup SSR (Svelte, server-only island)", () => {
  it("server-renders its playground section to a stable HTML string", () => {
    const { html } = render(RadioGroupSection, { props: { open: false } });
