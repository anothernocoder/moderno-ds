...
import SwitchSection from "../../playground/sections/Switch.svelte";

describe("Switch SSR (Svelte, server-only island)", () => {
  it("server-renders its playground section to a stable HTML string", () => {
    const { html } = render(SwitchSection, { props: { open: false } });
