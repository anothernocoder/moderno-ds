...
import AccordionSection from "../../playground/sections/Accordion.svelte";

describe("Accordion SSR (Svelte, server-only island)", () => {
  it("server-renders its playground section to a stable HTML string", () => {
    const { html } = render(AccordionSection, { props: { open: false } });
