...
import SliderSection from "../../playground/sections/Slider.svelte";

describe("Slider SSR (Svelte, server-only island)", () => {
  it("server-renders its playground section to a stable HTML string", () => {
    const { html } = render(SliderSection, { props: { open: false } });
