...
import NumberInputSection from "../../playground/sections/NumberInput.svelte";

describe("NumberInput SSR (Svelte, server-only island)", () => {
  it("server-renders its playground section to a stable HTML string", () => {
    const { html } = render(NumberInputSection, { props: { open: false } });
