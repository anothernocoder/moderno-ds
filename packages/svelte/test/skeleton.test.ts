...
describe("Skeleton (Svelte)", () => {
  ...
  it("maps shape to data-shape", () => {
    render(Skeleton, { props: { "data-testid": "skeleton", shape: "circle" } });
  ...
  it("forwards native props, including a size through style", () => {
    render(Skeleton, { props: { class: "mine", "data-testid": "skeleton", style: "width: 60%" } });
    const root = screen.getByTestId("skeleton");
