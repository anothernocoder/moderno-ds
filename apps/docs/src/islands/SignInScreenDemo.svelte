...
<script lang="ts">
  ...
  const copy = {
    en: {
      ...
      tabs: [
        { id: "phone", label: "Phone", caption: "Under --container-sm the masthead, the footer and the notices all stack under the card." },
        { id: "tablet", label: "Tablet", caption: "Past --container-md and under --container-lg the masthead and the footer each sit on one row, the notices still under the card." },
        { id: "desktop", label: "Desktop", caption: "Past --container-lg the notices stand beside the card; this frame is wider than the docs column, so scroll it sideways." },
      ],
    ...
    es: {
      ...
      tabs: [
        { id: "phone", label: "Teléfono", caption: "Por debajo de --container-sm la cabecera, el pie y los avisos se apilan bajo la tarjeta." },
        { id: "tablet", label: "Tableta", caption: "Entre --container-md y --container-lg la cabecera y el pie ocupan una fila cada uno, y los avisos siguen bajo la tarjeta." },
        { id: "desktop", label: "Escritorio", caption: "Por encima de --container-lg los avisos se colocan junto a la tarjeta; este marco es más ancho que la columna de la documentación, así que desplázalo en horizontal." },
      ],
