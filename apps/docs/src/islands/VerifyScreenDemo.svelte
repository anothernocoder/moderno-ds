  ...
  const copy = {
    en: {
      ...
      tabs: [
        ...
        { id: "desktop", label: "Desktop", caption: "Past --container-lg the notes stand beside the card, so “look in spam” is read while the inbox is still open; this frame is wider than the docs column, so scroll it sideways." },
      ],
    ...
    es: {
      ...
      tabs: [
        ...
        { id: "desktop", label: "Escritorio", caption: "Por encima de --container-lg las notas se ponen junto a la tarjeta, así que «mira en spam» se lee con la bandeja aún abierta; este marco es más ancho que la columna de la documentación, así que desplázalo en horizontal." },
      ],
