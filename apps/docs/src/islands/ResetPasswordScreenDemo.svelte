  ...
  const copy = {
    en: {
      ...
      tabs: [
        ...
        { id: "desktop", label: "Desktop", caption: "Past --container-lg the notes stand beside the card, so what this link does is read before the password is chosen; this frame is wider than the docs column, so scroll it sideways." },
      ],
    ...
    es: {
      ...
      tabs: [
        ...
        { id: "desktop", label: "Escritorio", caption: "Por encima de --container-lg las notas se ponen junto a la tarjeta, así que lo que hace este enlace se lee antes de elegir la contraseña; este marco es más ancho que la columna de la documentación, así que desplázalo en horizontal." },
      ],
