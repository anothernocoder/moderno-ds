...
export function TabsEnclosedDemo() {
  return (
    <Tabs.Root variant="enclosed" defaultValue="account">
      ...
      <Tabs.Content value="notifications">Choose what we email you about.</Tabs.Content>
    </Tabs.Root>
  );
}
