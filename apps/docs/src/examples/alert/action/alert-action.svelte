<!--
  ...
  description — @moderno-ui/svelte. The icon is inline SVG: primitives
  stay icon-agnostic, and the glyph strokes `currentColor`, which the
  `icon` part sets from the status hue.
