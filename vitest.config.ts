...
export default defineConfig({
  ...
  test: {
    ...
    // The ported framework packages own their compiler plugin + env, and the
    // agent-examples suites their globalSetup; they run as separate workspace
    // projects (see vitest.workspace.ts).
    exclude: [
      "**/node_modules/**",
      "packages/vue/**",
      "packages/solid/**",
      "packages/svelte/**",
      "packages/lint-core/test/rules/agent-examples.test.ts",
      "packages/lint-core/test/rules/agent-examples/**",
    ],
  },
});
