...
<!-- Generated by `pnpm theme:build` from registry/themes/theme-moderno/tokens.dtcg.json and the Moderno token contract. Only the brand notes are hand-written: edit them between the markers below; everything outside the markers is regenerated. -->
...
- **Do** change a value in the theme's source (`registry/themes/theme-moderno/tokens.dtcg.json`, or the Theme Builder) and rebuild. Never edit the front matter or `theme.css`.
