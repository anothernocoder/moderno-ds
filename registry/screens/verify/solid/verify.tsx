 ...
 * that: one cell per digit, `autocomplete="one-time-code"` on every one of them
 * so the platform can offer the code straight out of the notification, and a
 * paste of the whole string distributed across the cells rather than rejected.
 *
